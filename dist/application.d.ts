...
declare const LoopbackPlaygroundApplication_base: (new (...args: any[]) => {
    projectRoot: string;
...
export declare class LoopbackPlaygroundApplication extends LoopbackPlaygroundApplication_base {
